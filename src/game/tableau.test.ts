...
describe("Tableau", () => {
  it("should allow placing a King on an empty tableau column", () => {
    ...
    const kingCard: Card = { suit: "Hearts", rank: "K", faceUp: true };
    ...
    for (const rank of ranks) {
      const card: Card = { suit: "Hearts", rank, faceUp: true };
  ...
  it("should allow placing a card of opposite color and one rank lower on a non-empty tableau column", () => {
    const tableau: Tableau = [[], [], []];
    const topCard: Card = { suit: "Hearts", rank: "7", faceUp: true };
    tableau[0].push(topCard);

    const validCard: Card = { suit: "Clubs", rank: "6", faceUp: true };
    const invalidCardSameColor: Card = {
      suit: "Diamonds",
      rank: "6",
      faceUp: true,
    };
    const invalidCardWrongRank: Card = {
      suit: "Clubs",
      rank: "5",
      faceUp: true,
    };
    ...
    const topCard2: Card = { suit: "Spades", rank: "J", faceUp: true };
    tableau[1].push(topCard2);

    const validCard2: Card = { suit: "Hearts", rank: "10", faceUp: true };
    const invalidCardSameColor2: Card = {
      suit: "Spades",
      rank: "10",
      faceUp: true,
    };
    const invalidCardWrongRank2: Card = {
      suit: "Hearts",
      rank: "Q",
      faceUp: true,
    };
    ...
    expect(canPlaceCardOnTableau(tableau, invalidCardSameColor2, 1)).toBe(
      false,
    );
    expect(canPlaceCardOnTableau(tableau, invalidCardWrongRank2, 1)).toBe(
      false,
    );
  });
});
